    ...
    public override IEnumerator Update()
    {
        while (true)
        {
            ...
            if (joystick != null)
            {
                ...
                bool conditionXMet = Data.UseGreaterThanOrEqualX ? joystickValue.x >= Data.TargetValueX : joystickValue.x <= Data.TargetValueX;
                bool conditionYMet = Data.UseGreaterThanOrEqualY ? joystickValue.y >= Data.TargetValueY : joystickValue.y <= Data.TargetValueY;
