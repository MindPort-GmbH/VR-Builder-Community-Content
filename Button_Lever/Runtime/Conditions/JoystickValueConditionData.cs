...
namespace VRBuilder.Community
{
    ...
    public class JoystickValueConditionData : IConditionData
    {
        ...
        [DataMember] public float TargetValueX { get; set; }

        [DataMember] public float TargetValueY { get; set; }

        [DataMember] public float TimeThreshold { get; set; }

        [DataMember] public bool UseGreaterThanOrEqualX { get; set; } // Variable para X

        [DataMember] public bool UseGreaterThanOrEqualY { get; set; } // Variable para Y
